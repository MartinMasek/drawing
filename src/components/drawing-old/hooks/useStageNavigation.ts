...
export function useStageNavigation(
	...
	const getContainerPointFromEvent = useCallback(
		(evt: MouseEvent | PointerEvent): Point | null => {
	...
	const zoomAtContainerPoint = useCallback(
		(containerPoint: Point, factor: number) => {
