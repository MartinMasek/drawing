	...
	return (
		<div className="absolute top-3 left-3 z-50 flex w-11 flex-col items-center gap-1 rounded-[10px] bg-white py-1 shadow-lg">
			...
			{activeTab === DrawingTab.Edges && (
				<Button
					color={cursorType === CursorTypes.Egdes ? "primary" : "neutral"}
					iconOnly
					size="sm"
					variant={cursorType === CursorTypes.Egdes ? "outlined" : "text"}
					className="h-[36px] w-[36px]"
					onClick={() => setCursorType(CursorTypes.Egdes)}
				>
					<Icon size="md">
						{/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
						<svg
