...
export default function DistanceModal({ isOpen, rects, images, value, rectId, sinkId, onChange, onApply, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-3 text-base font-semibold text-gray-900">Adjust sink distance</div>
        <div className="mb-4 text-sm text-gray-700">Distance from left edge (px)</div>
        <input
          type="number"
          value={value}
          onChange={(e) => {
