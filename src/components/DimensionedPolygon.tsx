...
import { MIN_SIZE, DEFAULT_SIZE, SNAP_TO_ORIGIN, SNAP_SIZE, EDGE_TOLERANCE, IMAGE_OPTIONS, STAGE_WIDTH, STAGE_HEIGHT, L_TURN_MIN_PX, L_TURN_DEADBAND_PX } from "./drawing-old/constants";
import { generateRandomRects } from "./drawing-old/utils/dev";
import type { Point, RectDraft, EdgeName, CornerName, RectShape, ImageShape, DragDirection, InteractionMode, ToolMode, ContextMenuState, LineShape } from "./drawing-old/types";
import { findEdgeAtPointer as htFindEdge, findCornerAtPointer as htFindCorner, findRectAtPoint as htFindRect } from "./drawing-old/utils/hitTest";
import { draftForDrag as utilDraftForDrag } from "./drawing-old/utils/draft";
import { collectGroups, getBounds, getGroupRectsForRect } from "./drawing-old/utils/groups";
