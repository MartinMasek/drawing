	...
	theme: {
		...
		colors: {
			...
			text: {
				...
				button: {
					...
					primaryInverse: {
						default:
							"rgb(var(--text-button-other-brand-inverse-default) / <alpha-value> )",
						hover:
							"rgb(var(--text-button-other-brand-inverse-hover) / <alpha-value> )",
						active:
							"rgb(var(--text-button-other-brand-inverse-active) / <alpha-value> )",
						disabledOnColorBg:
							"rgb(var(--text-button-other-brand-inverse-disabled-on-color-bg) / <alpha-value> )",
						disabledOnWhiteBg:
							"rgb(var(--text-button-other-brand-inverse-disabled-on-white-bg) / <alpha-value> )",
					},
					secondary: {
						brand:
							"rgb(var(--text-button-other-secondary-brand) / <alpha-value> )",
						hover:
							"rgb(var(--text-button-other-secondary-hover) / <alpha-value> )",
						active: "rgb(var(--text-button-secondary-active) / <alpha-value> )",
						disabledOnColorBg:
							"rgb(var(--text-button-secondary-disabled-on-color-bg) / <alpha-value> )",
						disabledOnWhiteBg:
							"rgb(var(--text-button-other-secondary-disabled-on-white-bg) / <alpha-value> )",
					},
					gray: {
						default:
							"rgb(var(--text-button-other-gray-default) / <alpha-value> )",
						hover: "rgb(var(--text-button-other-gray-hover) / <alpha-value> )",
						active:
							"rgb(var(--text-button-other-gray-active) / <alpha-value> )",
						disabled:
							"rgb(var(--text-button-other-gray-disabled) / <alpha-value> )",
					},
					danger: {
						default:
							"rgb(var(--text-button-other-danger-default) / <alpha-value> )",
						hover:
							"rgb(var(--text-button-other-danger-hover) / <alpha-value> )",
						active:
							"rgb(var(--text-button-other-danger-active) / <alpha-value> )",
						disabledOnColorBg:
							"rgb(var(--text-button-other-danger-disabled-on-color-bg) / <alpha-value> )",
						disabledOnWhiteBg:
							"rgb(var(--text-button-other-danger-disabled-on-white-bg) / <alpha-value> )",
					},
				},
				tooltip: {
			...
			background: {
				neutral: {
					primary: {
						...
						selectedBold:
							"rgb(var(--bg-neutral-primary-selected-bold) / <alpha-value> )",
					...
					secondary: {
						default:
							"rgb(var(--bg-neutral-secondary-default) / <alpha-value> )",
				...
				checkboxes: {
					...
					selectedBorder:
						"rgb(var(--bg-checkboxes-selected-border) / <alpha-value> )",
					selectedFilled:
						"rgb(var(--bg-checkboxes-selected-filled) / <alpha-value> )",
					disabledFilled:
						"rgb(var(--bg-checkboxes-disabled-filled) / <alpha-value> )",
				},
				banners: {
					danger: {
					...
					informational: {
						...
						subtle:
							"rgb(var(--bg-banners-informational-subtle) / <alpha-value> )",
					},
				},
				button: {
					primary: {
						brand: {
							default:
								"rgb(var(--bg-button-primary-brand-default) / <alpha-value> )",
							hover:
								"rgb(var(--bg-button-primary-brand-hover) / <alpha-value> )",
							active:
								"rgb(var(--bg-button-primary-brand-active) / <alpha-value> )",
							disabled:
								"rgb(var(--bg-button-primary-brand-disabled) / <alpha-value> )",
						},
						danger: {
							default:
								"rgb(var(--bg-button-primary-danger-default) / <alpha-value> )",
							hover:
								"rgb(var(--bg-button-primary-danger-hover) / <alpha-value> )",
							active:
								"rgb(var(--bg-button-primary-danger-active) / <alpha-value> )",
							disabled:
								"rgb(var(--bg-button-primary-danger-disabled) / <alpha-value> )",
						},
					},
					secondary: {
						brand: {
						...
						dangerOutlined: {
							default:
								"rgb(var(--bg-button-secondary-danger-outlined-default) / <alpha-value> )",
							hover:
								"rgb(var(--bg-button-secondary-danger-outlined-hover) / <alpha-value> )",
							active:
								"rgb(var(--bg-button-secondary-danger-outlined-active) / <alpha-value> )",
							disabled:
								"rgb(var(--bg-button-secondary-danger-outlined-disabled) / <alpha-value> )",
						},
						grayOutlined: {
							default:
								"rgb(var(--bg-button-secondary-gray-outlined-default) / <alpha-value> )",
							hover:
								"rgb(var(--bg-button-secondary-gray-outlined-hover) / <alpha-value> )",
							active:
								"rgb(var(--bg-button-secondary-gray-outlined-active) / <alpha-value> )",
							disabled:
								"rgb(var(--bg-button-secondary-gray-outlined-disabled) / <alpha-value> )",
						},
					},
					terciary: {
						brand: {
							default:
								"rgb(var(--bg-button-terciary-brand-default) / <alpha-value> )",
							hover:
								"rgb(var(--bg-button-terciary-brand-hover) / <alpha-value> )",
							active:
								"rgb(var(--bg-button-terciary-brand-active) / <alpha-value> )",
							disabled:
								"rgb(var(--bg-button-terciary-brand-disabled) / <alpha-value> )",
						},
						danger: {
							default:
								"rgb(var(--bg-button-terciary-danger-default) / <alpha-value> )",
							hover:
								"rgb(var(--bg-button-terciary-danger-hover) / <alpha-value> )",
							active:
								"rgb(var(--bg-button-terciary-danger-active) / <alpha-value> )",
							disabled:
								"rgb(var(--bg-button-terciary-danger-disabled) / <alpha-value> )",
						},
						gray: {
							default:
								"rgb(var(--bg-button-terciary-gray-default) / <alpha-value> )",
							hover:
								"rgb(var(--bg-button-terciary-gray-hover) / <alpha-value> )",
							active:
								"rgb(var(--bg-button-terciary-gray-active) / <alpha-value> )",
							disabled:
								"rgb(var(--bg-button-terciary-gray-disabled) / <alpha-value> )",
						},
					},
				},
				...
				progressBar: {
					...
					progressline:
						"rgb(var(--bg-progressbar-progressline) / <alpha-value> )",
				},
				stepper: {
					active: {
				...
				toggle: {
					...
					disabledFilled:
						"rgb(var(--bg-toggle-disabled-filled) / <alpha-value> )",
					selectedSuccess:
						"rgb(var(--bg-toggle-selected-success) / <alpha-value> )",
					selectedFilled:
						"rgb(var(--bg-toggle-selected-filled) / <alpha-value> )",
				},
			...
			border: {
				...
				button: {
					brand: {
						default:
							"rgb(var(--border-button-border-brand-default) / <alpha-value> )",
						hover:
							"rgb(var(--border-button-border-brand-hover) / <alpha-value> )",
						active:
							"rgb(var(--border-button-border-brand-active) / <alpha-value> )",
						disabled:
							"rgb(var(--border-button-border-brand-disabled) / <alpha-value> )",
					},
					danger: {
						default:
							"rgb(var(--border-button-border-danger-default) / <alpha-value> )",
						hover:
							"rgb(var(--border-button-border-danger-hover) / <alpha-value> )",
						active:
							"rgb(var(--border-button-border-danger-active) / <alpha-value> )",
						disabled:
							"rgb(var(--border-button-border-danger-disabled) / <alpha-value> )",
					},
					gray: {
						default:
							"rgb(var(--border-button-border-gray-default) / <alpha-value> )",
						hover:
							"rgb(var(--border-button-border-gray-hover) / <alpha-value> )",
						active:
							"rgb(var(--border-button-border-gray-active) / <alpha-value> )",
						disabled:
							"rgb(var(--border-button-border-gray-disabled) / <alpha-value> )",
					},
				},
				colors: {
					brand: {
		...
		extend: {
			...
			boxShadow: {
				...
				"general-focus-dark":
					"0px 0px 0px 4px rgba(var(--color-primary-900) / .60), 0px 1px 2px 0px rgba(0, 0, 0, 0.05)",
				"error-focus":
					"0px 0px 0px 4px rgba(var(--color-error-200) / .60), 0px 1px 2px 0px rgba(0, 0, 0, 0.05)",
				"error-focus-dark":
					"0px 0px 0px 4px rgba(var(--color-error-900) / .60), 0px 1px 2px 0px rgba(0, 0, 0, 0.05)",
			},
			gridTemplateColumns: {
